...
const Home = () => {
  return (
    <div className='h-[100vh] flex flex-col items-center justify-center gap-5 lg:gap-0 lg:flex-row bg-green-950'>
      ...
      <div>
        <img src="https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/c629a8180535451.650c3b7572921.png" alt="Image" className=''/>
      </div>
    </div>
  )
}
